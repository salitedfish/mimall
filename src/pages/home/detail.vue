<template>
  <div class="detail">
    <product-param :name="name"></product-param>
    <div class="container">
      <div class="detail-content">
        <div class="swipper-detail"></div>
        <div class="detail-info">
          ...
          <div class="price">
            <span class="price-new">2599元</span>
            <span class="price-old">2999元</span>
          </div>
          ...
          <div class="edition">
            ...
            <div class="choice">
              <div class="choice-no choiced">
                6GB+64GB 全网通 <span>1099元</span>
              </div>
              <div class="choice-no">4GB+64GB 移动4G <span>1049元</span></div>
            </div>
          </div>
          <div class="color">
          ...
          <div class="result">
            <span class="result-choice">小米8 6GB+64GB 全网通 深灰色</span>
            <span class="result-price-one">1099元</span>
            <span class="result-price-two">1699元</span>
            <div class="result-price-new">总计: 1099元</div>
          </div>
          <button class="btn btn-huge">加入购物车</button>
